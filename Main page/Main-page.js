 ...
 function scrollToTop2() {
  ...
  const translations = {
    en: {
      ...
      HistoryCulture: 'What will you learn about each country on our page?',
  contryTittle: 'What will you find on this website?',
    ...
    uk: {
      ...
      HistoryCulture: 'Що ви дізнаєтесь про кожну країну на нашій сторінці?',
  contryTittle: 'Що ви знайдете на цьому сайті?',
    }
  };
